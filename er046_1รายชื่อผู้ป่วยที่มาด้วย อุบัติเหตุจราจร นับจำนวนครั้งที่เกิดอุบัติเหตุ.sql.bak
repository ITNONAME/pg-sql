...
where
 SUBSTRING(t_visit.visit_begin_visit_time,1,10) between substr('2560-01-01',1,10) and substr('2560-03-31',1,10)
 --SUBSTRING(t_visit.visit_begin_visit_time,1,10) between substr(?,1,10) and substr(?,1,10)
 and t_visit.f_visit_status_id <> '4'
GROUP BY hn,ชื่อสกุล,วันที่เข้ารับบริการ,วันที่เกิดอุบัติเหตุ,เวลาที่เกิดอุบัติเหตุ,สถานที่เกิดเหตุ,ผู้บันทึก,ตำบล,ประเภทการมา_รพ,ระดับความรุนแรง
order by วันที่เกิดอุบัติเหตุ,เวลาที่เกิดอุบัติเหตุ