select distinct
            ...
            then '0581902'--'11'
            when b_item_lab_ncd_std.b_item_lab_ncd_std_id='ncd201000000000022'--'ncd201000000000021'
            then '0440204'--'12'
...
where  
		...
		OR b_item_lab_ncd_std.b_item_lab_ncd_std_id='ncd201000000000019' OR b_item_lab_ncd_std.b_item_lab_ncd_std_id='ncd201000000000020' OR b_item_lab_ncd_std.b_item_lab_ncd_std_id='ncd201000000000022')
        AND t_visit.f_visit_type_id <> 'S'
        AND t_visit.f_visit_status_id ='3'
        AND t_visit.visit_money_discharge_status='1'
        AND t_visit.visit_doctor_discharge_status='1' 				
        AND substr( t_visit.visit_staff_doctor_discharge_date_time,1,10) between '2559-10-01' and '2560-06-11'    
